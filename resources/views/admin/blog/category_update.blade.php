...
if ($model && $model->id) {
    $action = route('admin.ajax.post-category.update', ['post_category' => $model->id, '_method' => 'PUT']);
    $breadcrumbsName = 'postCategory';
} else {
    $action = route('admin.ajax.post-category.store');
    $breadcrumbsName = 'postCategoryNew';
}
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="list-with-gap mb-2">
                                    ...
                                    <a type="button" class="btn btn-secondary" href="{{ route('admin.post-category.index') }}">Выйти</a>
                                </div>
                                <div class="list-with-gap mb-2">
