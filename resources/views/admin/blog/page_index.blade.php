        ...
        <div class="card js-index-card">
            <div class="card-body js-index-card-inner">
                <div class="btn-group btn-group-sm mb-3" role="group">
                    <a class="btn btn-light has-icon" href="{{ route('admin.page.create') }}">
                        <i class="material-icons mr-1">add_circle_outline</i>Новая
                    </a>
                    <a type="button" class="btn btn-light has-icon" href="{{ route('admin.page.index') }}">
                ...
                <div class="table-responsive">
                    <form id="index-form-filter" action="{{ route('admin.page.index') }}" method="post"></form>
                    <table
                            ...
                            <tr class="js-producer-table">
                                ...
                                <td class="td-col-action text-center">
                                    <div class="btn-group btn-group-xs" role="group">
                                        <a href="{{ route('admin.page.edit',['page' => $item->id ]) }}"
                                        ...
                                        <a href="{{ route('admin.page.destroy',['page' => $item->id ]) }}"
