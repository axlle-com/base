...
@section('content')
    <div class="main-body">
        {{ Breadcrumbs::render('postCategories') }}
        <h5>{{ $title }}</h5>
        <div class="card js-index-card">
            <div class="card-body js-index-card-inner">
                <div class="btn-group btn-group-sm mb-3" role="group">
                    <a class="btn btn-light has-icon" href="{{ route('admin.post-category.create') }}">
                            ...
                            <tr class="js-producer-table">
                                ...
                                <td class="td-col-action text-center">
                                    <div class="btn-group btn-group-xs" role="group">
                                        <a href="{{ route('admin.post-category.edit',['post_category' => $item->id ]) }}"
                                        ...
                                        <a href="{{ route('admin.post-category.destroy',['post_category' => $item->id ]) }}"
