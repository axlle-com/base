...
(
    ...
    `render`              VARCHAR(255)        NULL DEFAULT NULL,
...
-- -----------------------------------------------------
-- Table `ax_blog`.`info_block_has_resource`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `ax_blog`.`info_block_has_resource`;

CREATE TABLE IF NOT EXISTS `ax_blog`.`info_block_has_resource`
(
    `id`            INT UNSIGNED NOT NULL AUTO_INCREMENT,
    `resource`      VARCHAR(255) NOT NULL,
    `resource_id`   INT UNSIGNED NOT NULL,
    ...
    `sort`          INT          NULL DEFAULT 0,
    INDEX `fk_info_block_has_resource_info_block1_idx` (`info_block_id` ASC),
    PRIMARY KEY (`id`),
    INDEX `info_block_has_resource_resource` (`resource` ASC),
    INDEX `info_block_has_resource_resource_id` USING BTREE (`resource_id`),
